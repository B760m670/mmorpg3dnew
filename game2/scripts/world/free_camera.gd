...
##   «схвати мир»: сцена едет за пальцами (то, что под пальцами, следует за ними).
...
func _two_finger() -> void:
	...
	# перенос «схвати мир»: сцена едет за пальцами (без инверсии для пользователя) —
	# пальцы вверх → содержимое вверх (камера вниз), пальцы вправо → содержимое вправо
