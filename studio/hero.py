...
MUSCLE = {
    ...
    # ГЛУБИНА ГРУДНОЙ КЛЕТКИ. «Плоская грудь, нет грудной клетки» — верное
    # наблюдение, и лечится оно не шириной, а глубиной: у мужчины сечение
    # груди почти круглое, у нас было заметно приплюснутое спереди назад.
    "torso-scale-depth": 0.40,
